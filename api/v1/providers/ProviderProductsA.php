 ...
 * for airtime, electricity, education, and cable (which don't change often).
 */
class ProviderProductsA
{
    ...
    /** Education / Exam pin services — WAEC, JAMB, NECO, NABTEB */
    public static function getEducationProducts(): array
    {
        return [
            ['plan_id' => 'waec-result',   'plan_name' => 'WAEC Result Checker',     'network' => 'waec',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 3550.00],
            ['plan_id' => 'waec-gce',      'plan_name' => 'WAEC GCE Registration',   'network' => 'waec',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 22500.00],
            ['plan_id' => 'jamb-utme',     'plan_name' => 'JAMB UTME e-PIN',         'network' => 'jamb',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 6200.00],
            ['plan_id' => 'jamb-de',       'plan_name' => 'JAMB Direct Entry e-PIN', 'network' => 'jamb',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 4700.00],
            ['plan_id' => 'neco-result',   'plan_name' => 'NECO Result Checker',     'network' => 'neco',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 1500.00],
            ['plan_id' => 'neco-gce',      'plan_name' => 'NECO GCE Registration',   'network' => 'neco',   'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 16800.00],
            ['plan_id' => 'nabteb-result', 'plan_name' => 'NABTEB Result Checker',   'network' => 'nabteb', 'service' => 'education', 'type' => 'education', 'volume' => '', 'duration' => null, 'validity_type' => '', 'price' => 1000.00],
        ];
    }
    ...
    /**
     * Scrape CheapDataHub's plan-ID table and merge with ALL static service lists.
     *
    ...
    public static function getCheapDataProducts(): array
    {
        ...
        // Merge scraped data plans with ALL static service lists
        return array_merge(
            $plans,
